...
from Asynchronous_Reinforcement_Learning.utils.get_available_gpus import get_gpus_without_triggering_pytorch_cuda_initialization
from Asynchronous_Reinforcement_Learning.utils.utils import log, memory_consumption_mb

CUDA_ENVVAR = 'CUDA_VISIBLE_DEVICES'


class TaskType:
    INIT, TERMINATE, RESET, ROLLOUT_STEP, POLICY_STEP, TRAIN, INIT_MODEL, PBT, UPDATE_ENV_STEPS, EMPTY,ROLLOUT_OVER,PRETERMINATE,SUSPEND,PRESUSPEND,START,SET_PARA,GET_PARA = range(17)
