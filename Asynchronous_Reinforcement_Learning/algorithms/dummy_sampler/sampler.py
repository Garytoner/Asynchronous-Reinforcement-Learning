...
from Asynchronous_Reinforcement_Learning.algorithms.algorithm import AlgorithmBase
from Asynchronous_Reinforcement_Learning.algorithms.appo.appo_utils import make_env_func, set_gpus_for_process, set_global_cuda_envvars
...
from Asynchronous_Reinforcement_Learning.utils.utils import log, AttrDict, set_process_cpu_affinity, str2bool, memory_consumption_mb
...
# python -m Asynchronous_Reinforcement_Learning.run_algorithm --algo=DUMMY_SAMPLER --env=doom_benchmark --env_frameskip=4 --res_w=128 --res_h=72 --wide_aspect_ratio=False --num_workers=20 --num_envs_per_worker=10 --sample_env_frames=2000000 --experiment=test
# python -m Asynchronous_Reinforcement_Learning.run_algorithm --algo=DUMMY_SAMPLER --env=dmlab_benchmark --env_frameskip=4 --num_workers=20 --num_envs_per_worker=10 --sample_env_frames=2000000 --experiment=test
