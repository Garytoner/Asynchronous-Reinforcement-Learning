...
from Asynchronous_Reinforcement_Learning.algorithms.utils.evaluation_config import add_eval_args
from Asynchronous_Reinforcement_Learning.envs.env_config import add_env_args, env_override_defaults
from Asynchronous_Reinforcement_Learning.utils.utils import log, AttrDict, cfg_file, get_git_commit_hash
...
def get_algo_class(algo):
    ...
    if algo == 'APPO':
        ...
        from Asynchronous_Reinforcement_Learning.algorithms.dummy_sampler.sampler import DummySampler
