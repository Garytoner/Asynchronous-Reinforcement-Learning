...
from Asynchronous_Reinforcement_Learning.utils.utils import log, project_tmp_dir

from Asynchronous_Reinforcement_Learning.envs.doom.fixRender import SimpleImageViewer
    ...
    def _game_init(self, with_locking=True, max_parallel=10):
        ...
        while True:
            ...
            try:
                ...
                from Asynchronous_Reinforcement_Learning.envs.env_utils import EnvCriticalError
