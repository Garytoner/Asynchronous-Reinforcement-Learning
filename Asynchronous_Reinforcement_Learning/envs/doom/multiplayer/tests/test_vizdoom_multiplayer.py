...
from Asynchronous_Reinforcement_Learning.envs.env_utils import vizdoom_available
...
class TestDoom(TestCase):
    ...
    def make_standard_dm(env_config):
        ...
        from Asynchronous_Reinforcement_Learning.envs.tests.test_envs import default_doom_cfg
