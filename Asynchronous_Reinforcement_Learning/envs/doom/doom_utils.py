...
from Asynchronous_Reinforcement_Learning.envs.doom.action_space import doom_action_space, \
...
from Asynchronous_Reinforcement_Learning.envs.doom.doom_gym import VizdoomEnv

from Asynchronous_Reinforcement_Learning.envs.doom.doom_model import register_models
from Asynchronous_Reinforcement_Learning.envs.doom.wrappers.additional_input import DoomAdditionalInput
from Asynchronous_Reinforcement_Learning.envs.doom.wrappers.bot_difficulty import BotDifficultyWrapper
from Asynchronous_Reinforcement_Learning.envs.doom.wrappers.multiplayer_stats import MultiplayerStatsWrapper
from Asynchronous_Reinforcement_Learning.envs.doom.wrappers.observation_space import SetResolutionWrapper, resolutions
from Asynchronous_Reinforcement_Learning.envs.doom.wrappers.reward_shaping import true_reward_final_position, DoomRewardShapingWrapper, \
    REWARD_SHAPING_DEATHMATCH_V0, true_reward_frags, REWARD_SHAPING_DEATHMATCH_V1, REWARD_SHAPING_BATTLE
from Asynchronous_Reinforcement_Learning.envs.doom.wrappers.scenario_wrappers.gathering_reward_shaping import DoomGatheringRewardShaping
from Asynchronous_Reinforcement_Learning.envs.env_wrappers import ResizeWrapper, RewardScalingWrapper, TimeLimitWrapper, RecordingWrapper, \
...
def make_doom_env_impl(
    ...
    if player_id is None:
        ...
        from Asynchronous_Reinforcement_Learning.envs.doom.multiplayer.doom_multiagent import VizdoomEnvMultiplayer
...
def make_doom_multiplayer_env(doom_spec, cfg=None, env_config=None, **kwargs):
    ...
    if is_multiagent:
        ...
        from Asynchronous_Reinforcement_Learning.envs.doom.multiplayer.doom_multiagent_wrapper import MultiAgentEnv
        env = MultiAgentEnv(
        ...
        from Asynchronous_Reinforcement_Learning.envs.doom.multiplayer.doom_multiagent_wrapper import init_multiplayer_env
