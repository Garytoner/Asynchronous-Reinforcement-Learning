...
class EnvRegistry:
    ...
    def register_env(
        ...
        See the Asynchronous_Reinforcement_Learning_examples for the default envs, it's actually very simple.
    ...
    def resolve_env_name(self, full_env_name):
        ...
        msg = (f'Could not resolve {full_env_name}. '
               'Did you register the family of environments in the registry? See Asynchronous_Reinforcement_Learning_examples for details.')
        log.warning(msg)
        raise RuntimeError(msg)


def doom_funcs():
    from Asynchronous_Reinforcement_Learning.envs.doom.doom_utils import make_doom_env
    from Asynchronous_Reinforcement_Learning.envs.doom.doom_params import add_doom_env_args, doom_override_defaults
    return make_doom_env, add_doom_env_args, doom_override_defaults


def atari_funcs():
    from Asynchronous_Reinforcement_Learning.envs.atari.atari_utils import make_atari_env
    from Asynchronous_Reinforcement_Learning.envs.atari.atari_params import atari_override_defaults
    return make_atari_env, None, atari_override_defaults


def dmlab_funcs():
    from Asynchronous_Reinforcement_Learning.envs.dmlab.dmlab_env import make_dmlab_env
    from Asynchronous_Reinforcement_Learning.envs.dmlab.dmlab_params import add_dmlab_env_args, dmlab_override_defaults
    return make_dmlab_env, add_dmlab_env_args, dmlab_override_defaults


def mujoco_funcs():
    from Asynchronous_Reinforcement_Learning.envs.mujoco.mujoco_utils import make_mujoco_env
    from Asynchronous_Reinforcement_Learning.envs.mujoco.mujoco_params import add_mujoco_env_args, mujoco_override_defaults
    return make_mujoco_env, add_mujoco_env_args, mujoco_override_defaults


def minigrid_funcs():
    from Asynchronous_Reinforcement_Learning.envs.minigrid.minigrid_utils import make_minigrid_env
    from Asynchronous_Reinforcement_Learning.envs.minigrid.minigrid_params import minigrid_override_defaults
    return make_minigrid_env, None, 
    
def maze_funcs():
    from Asynchronous_Reinforcement_Learning.envs.maze.maze_utils import make_maze_env
    from Asynchronous_Reinforcement_Learning.envs.maze.maze_params import maze_override_defaults
    return make_maze_env, None, maze_override_defaults

def minihack_funcs():
    from Asynchronous_Reinforcement_Learning.envs.minihack.minihack_utils import make_minihack_env
    from Asynchronous_Reinforcement_Learning.envs.minihack.minihack_params import minihack_override_defaults
    return make_minihack_env, None, minihack_override_defaults

def gym_funcs():
    from Asynchronous_Reinforcement_Learning.envs.gym.gym_utils import make_gym_env
    from Asynchronous_Reinforcement_Learning.envs.gym.gym_params import gym_override_defaults
