...
from Asynchronous_Reinforcement_Learning.runner.run_ngc import add_ngc_args
from Asynchronous_Reinforcement_Learning.runner.run_slurm import add_slurm_args
...
def runner_argparser():
    ...
    parser.add_argument('--run', default=None, type=str, help='Name of the python module that describes the run, e.g. Asynchronous_Reinforcement_Learning.runner.runs.doom_battle_hybrid')
...
def main():
    ...
    try:
        ...
        try:
            run_module = importlib.import_module(f'Asynchronous_Reinforcement_Learning.runner.runs.{args.run}')
        except ImportError:
    ...
    if args.runner == 'processes':
        from Asynchronous_Reinforcement_Learning.runner.run_processes import run
        run(run_description, args)
    elif args.runner == 'slurm':
        from Asynchronous_Reinforcement_Learning.runner.run_slurm import run_slurm
        run_slurm(run_description, args)
    elif args.runner == 'ngc':
        from Asynchronous_Reinforcement_Learning.runner.run_ngc import run_ngc
