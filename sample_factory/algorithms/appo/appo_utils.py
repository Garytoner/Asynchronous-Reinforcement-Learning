...
class TaskType:
    INIT, TERMINATE, RESET, ROLLOUT_STEP, POLICY_STEP, TRAIN, INIT_MODEL, PBT, UPDATE_ENV_STEPS, EMPTY,ROLLOUT_OVER,PRETERMINATE,SUSPAND,PRESUSPAND,START,SET_PARA,GET_PARA = range(17)
