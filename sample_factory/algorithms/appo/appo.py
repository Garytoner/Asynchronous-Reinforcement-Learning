...
from sample_factory.algorithms.appo.appo_utils import TaskType,make_env_func, iterate_recursively, set_global_cuda_envvars
...
class CFG:
    def __init__(
        ...
        self.wandb_project = "sample_factory"
