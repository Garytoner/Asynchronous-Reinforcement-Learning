...
MUJOCO_ENVS = [
    ...
    MujocoSpec('mujoco_CartPolev0', 'CartPole-v0'),
    MujocoSpec('mujoco_CartPolev1', 'CartPole-v1'),
    MujocoSpec('mujoco_nasimlarge', 'nasim:LargeGen-v0'),
    MujocoSpec('mujoco_nasimmedium', 'nasim:Medium-v0'),
    MujocoSpec('mujoco_nasimsmall', 'nasim:Small-v0'),
]
